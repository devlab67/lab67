    ...
    * ------------------------------------------------------ */
    const ssAjaxChimp = function() {
        ...
        $.ajaxChimp.translations.es = {
            'submit': 'Aan het inschrijven...',
            0: '<i class="fas fa-check"></i> We hebben je inschrijving ontvangen.',
            1: '<i class="fas fa-exclamation-triangle"></i> Je e-mail is niet geldig.',
            2: '<i class="fas fa-exclamation-triangle"></i> E-mail is niet geldig.',
            3: '<i class="fas fa-exclamation-triangle"></i> E-mail is niet geldig.',
            4: '<i class="fas fa-exclamation-triangle"></i> E-mail is niet geldig.',
            5: '<i class="fas fa-exclamation-triangle"></i> E-mail is niet geldig.'
        }
    };
